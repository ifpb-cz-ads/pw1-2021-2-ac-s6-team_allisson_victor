...
# Para fazer essa verificação, calcule o resto da divisão do número por 2 e depois por todos
# os números ímpares até o número lido. Se o resto de uma dessas divisões for igual a zero, 
